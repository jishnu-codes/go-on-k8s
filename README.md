...
# Inspiration
After gained some operational knowledge on k8s (CKA and CKAD certifications), operators has been one of the topics that took the attention. Learning Go is always helpful in the journey of kubernetes experiments, decided to learn it by doing real tasks, REST-API apps are best to start with. 
